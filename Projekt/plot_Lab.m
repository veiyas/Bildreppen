...
%          Miguel Ángel Martínez Domingo - m.martinez.domingo@gmx.com
%
...
disp('');
disp('-> plot_Lab.m developed by: Timo Eckhard - timo.eckhard@gmx.com, Miguel Ángel Martínez Domingo - m.martinez.domingo@gmx.com');
